...
Firstly, we start the run in the same way as [Any% glitched](https://github.com/antimatterhorse/sm_anyglitched/blob/main/anyg.org)
...
As we explain the route below, please follow along [this video](https://youtu.be/1z3tL2sQDvc) 
...
[This picture](https://github.com/antimatterhorse/sm_anyglitched/blob/main/0g-mem.png) shows how the memory values look before the 2 X-rays, and how it looks after both X-rays. It is probably possible to accomplish these things with a single X-ray, that would save time.
